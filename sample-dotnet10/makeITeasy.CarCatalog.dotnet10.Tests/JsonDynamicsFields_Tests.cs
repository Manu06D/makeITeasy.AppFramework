...
using makeITeasy.CarCatalog.dotnet10.Core.Services.Queries.EngineQueries;
...
{
    public class JsonDynamicsFields_Tests(DatabaseFixture databaseEngineFixture) : AutofacFixture(databaseEngineFixture)
    {
        [Fact]
